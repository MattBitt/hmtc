...
def Timeline(videoTime, totalDuration, sections, event_update_video_time):
    pass
...
def Sectionalizer():
    ...
    def onUpdateVideoTime(new_time: float):
    ...
    with solara.Column(align="center"):
        ...
        Timeline(
            ...
            event_update_video_time=onUpdateVideoTime
        )
        ...
        with solara.Row():
            solara.Button(
                "Mark Start",
                color="success",
                on_click=lambda: sections.set(sections.value + [asdict(Section(video_time.value))]),
            )
