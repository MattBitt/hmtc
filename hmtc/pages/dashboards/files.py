        ...
        with solara.Columns([9, 3]):
            with solara.Column():
                ...
                with solara.Row():
                    ...
                    solara.Text(f"Subtitles {subtitle_files}", classes=["mx-6"])
                    solara.Text(f"Video Files {video_files}", classes=["mx-6"])
                    solara.Text(f"Audio Files {audio_files}", classes=["mx-6"])
