...
#     pathlib.Path(__file__).parent.resolve(), "cred.json"
# )
...
#         if (
#             "ProviderIds" in resultItem
#             and "Tmdb" in resultItem["ProviderIds"]
#             and inputItem["tmdb_id"] != 0
#             and resultItem["ProviderIds"]["Tmdb"] != inputItem["tmdb_id"]
#         ):
#             return False
#         elif "ProviderIds" in resultItem and "Tmdb" not in resultItem["ProviderIds"]:
#             if (
#                 inputItem["year"] != 0
#                 and resultItem["ProductionYear"] != inputItem["year"]
#             ):
#                 return False
...
#     payload = {"Name": title, "Ids": [], "UserId": user_id, "MediaType": None}
