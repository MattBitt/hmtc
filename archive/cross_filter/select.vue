<template>
  <v-autocomplete :items="items" v-model="value" :messages="messages" :multiple="multiple"
    :return-object="return_object" :clearable="clearable" :label="label" class="solara-cross-filter-select">
